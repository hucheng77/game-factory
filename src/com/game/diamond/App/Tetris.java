...
public class Tetris extends JPanel {
    ...
    static {
        try {
            I = ImageIO.read(new File("resources/diamondImg/I.png"));
            J = ImageIO.read(new File("resources/diamondImg/J.png"));
            L = ImageIO.read(new File("resources/diamondImg/L.png"));
            O = ImageIO.read(new File("resources/diamondImg/O.png"));
            S = ImageIO.read(new File("resources/diamondImg/S.png"));
            T = ImageIO.read(new File("resources/diamondImg/T.png"));
            Z = ImageIO.read(new File("resources/diamondImg/Z.png"));
            background = ImageIO.read(new File("resources/diamondImg/background.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
