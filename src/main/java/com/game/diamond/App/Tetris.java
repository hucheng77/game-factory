...
public class Tetris extends JPanel {
    ...
    static {
        try {
            I = ImageIO.read(new File("src/main/java/com/game/diamond/statics/I.png"));
            J = ImageIO.read(new File("src/main/java/com/game/diamond/statics/J.png"));
            L = ImageIO.read(new File("src/main/java/com/game/diamond/statics/L.png"));
            O = ImageIO.read(new File("src/main/java/com/game/diamond/statics/O.png"));
            S = ImageIO.read(new File("src/main/java/com/game/diamond/statics/S.png"));
            T = ImageIO.read(new File("src/main/java/com/game/diamond/statics/T.png"));
            Z = ImageIO.read(new File("src/main/java/com/game/diamond/statics/Z.png"));
            background = ImageIO.read(new File("src/main/java/com/game/diamond/statics/background.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
